...
time_am = timeit.repeat("inter.tc_with_adjacency_matrix()", setup="from __main__ import Graph, inter", repeat=5, number=1)
...
time_s = timeit.repeat("inter.tc_with_sqr()", setup="from __main__ import Graph, inter", repeat=5, number=1)
